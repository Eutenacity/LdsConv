...
#parser.set_defaults(resume='save/save_models/checkpoint_001.pth.tar')
best_prec1 = 0
...
def adjust_learning_rate(optimizer, epoch, args, batch=None,
    ...
    if method == 'cosine':
        ...
        if epoch < 100:
            T_total = 200 * nBatch
            T_cur = (epoch % 200) * nBatch + batch
        else:
            T_total = (200) * nBatch
            T_cur = ((epoch-100) % 200) * nBatch + batch
